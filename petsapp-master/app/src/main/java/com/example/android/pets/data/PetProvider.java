...
/**
 * Created by nayir on 3/28/2017.
 */
public class PetProvider extends ContentProvider {
    public static final String LOG_TAG = PetProvider.class.getSimpleName();
    final static int PETS = 100;
    final static int PET_ID = 101;
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        Long id = databasewrite.insert(PetContract.PetEntry.TABLE_NAME, null, values);
        if (id == -1)
            return null;
